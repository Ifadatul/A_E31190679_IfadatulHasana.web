                                    ...
                                    <form class="user" action="<?php echo base_url('Login/cek_log');?>" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                ...
                                                placeholder="username..." nama="txt_user">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="txt_pass">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="submit" nama="btn_log" value="Login" class="btn btn-primary btn-user btn-block">
                                        <hr>
